...
import hyperion.com.instagramclone2.easyvideoplayer.EasyVideoCallback;
import hyperion.com.instagramclone2.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
