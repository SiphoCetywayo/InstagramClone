...
//    mButtonVideo = (ImageButton) view.findViewById(R.id.video);
    ...
    int primaryColor = getArguments().getInt(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR);
...
//              mDelayStartCountdown.setVisibility(View.GONE);
  ...
  protected final File getOutputMediaFile() {
    return CameraUtil.makeTempFile(
        getActivity(), getArguments().getString(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.SAVE_DIR), "VID_", ".mp4");
  }

  @NonNull
  protected final File getOutputPictureFile() {
    return CameraUtil.makeTempFile(
        getActivity(), getArguments().getString(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.SAVE_DIR), "IMG_", ".jpg");
  }
...
//    else if (id == R.id.video) {
      ...
      if (mIsRecording) {
        ...
        if (getArguments().getBoolean(hyperion.com.instagramclone2.materialcamera.internal.CameraIntentKey.SHOW_PORTRAIT_WARNING, true)
